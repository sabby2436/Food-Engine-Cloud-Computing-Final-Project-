...
apigClientFactory.newClient = function (config) {
    ...
    var invokeUrl = 'https://8t7zkzh0ng.execute-api.us-east-1.amazonaws.com/Prod';
    ...
    apigClient.signoutOptions = function (params, body, additionalParams) {
        if(additionalParams === undefined) { additionalParams = {}; }
        
        apiGateway.core.utils.assertParametersDefined(params, [], ['body']);
        
        var signoutOptionsRequest = {
            verb: 'options'.toUpperCase(),
            path: pathComponent + uritemplate('/signout').expand(apiGateway.core.utils.parseParametersToObject(params, [])),
            headers: apiGateway.core.utils.parseParametersToObject(params, []),
            queryParams: apiGateway.core.utils.parseParametersToObject(params, []),
        ...
        return apiGatewayClient.makeRequest(signoutOptionsRequest, authType, additionalParams, config.apiKey);
    };
